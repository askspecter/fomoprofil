...
export default function ExplorePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pt-10 sm:pt-14">
      ...
      <div className="mt-10">
        <h2 className="text-xs font-semibold uppercase tracking-[0.25em] text-zinc-500">Recent on Vibz</h2>
        {recent === null ? (
          ...
          <p className="mt-3 text-sm text-zinc-500">No profiles launched on Vibz yet.</p>
        ) : (
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            {recent.map((it) => (
