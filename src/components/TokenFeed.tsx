...
/** A profile coin launched through Vibz (from /api/launches). */
...
/**
 * Live feed of profile coins launched through Vibz. Refreshes on an interval
  ...
  if (ranked.length === 0) {
    return (
      <div className="card p-10 text-center">
        <p className="text-sm text-zinc-600">No profiles launched on Vibz yet. Be the first.</p>
