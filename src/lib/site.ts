...
export const SITE = {
  ...
  description:
    "Turn your fomo.family profile into a token. FOMO Profile drafts your profile coin and launches it on the Pons v2 bonding curve on Robinhood Chain, non-custodial — your wallet signs every transaction.",
