...
/**
 * FOMO Profile's profile-package generator.
 *
...
const CREATIVE_RULES = `You are the creative engine of FOMO Profile, an app that tokenizes a person's fomo.family profile and launches it on the Pons v2 bonding curve (Robinhood Chain).
